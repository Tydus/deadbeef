...
create_mainwin (void)
{
  ...
  gtk_check_menu_item_set_active (GTK_CHECK_MENU_ITEM (view_eq), TRUE);

  view_artwork = gtk_check_menu_item_new_with_mnemonic (_("View Artwork"));
  gtk_widget_show (view_artwork);
  gtk_container_add (GTK_CONTAINER (View_menu), view_artwork);
  gtk_check_menu_item_set_active (GTK_CHECK_MENU_ITEM (view_artwork), TRUE);
  ...
  gtk_box_pack_start (GTK_BOX (vbox1), hbox104, TRUE, TRUE, 0);
  ...
  gtk_box_pack_start (GTK_BOX (hbox104), frame1, TRUE, TRUE, 0);
  ...
  g_signal_connect ((gpointer) view_eq, "activate",
                    ...
                    NULL);
  g_signal_connect ((gpointer) view_artwork, "activate",
                    G_CALLBACK (on_toggle_artwork),
                    NULL);
  ...
  GLADE_HOOKUP_OBJECT (mainwin, view_artwork, "view_artwork");
